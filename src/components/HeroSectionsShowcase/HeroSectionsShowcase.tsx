...
export default function HeroSectionsShowcase() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div 
          className="relative w-full max-w-[100vw] h-[150px] md:h-[648px] flex items-center justify-center"
          onPanEnd={(e, info) => {
            ...
            {SHOWCASE_ITEMS.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`absolute w-[80vw] md:w-[851px] lg:w-[1043px] h-[150px] md:h-[532px] lg:h-[648px] rounded-[20px] md:rounded-[30px] border-2 border-black overflow-hidden cursor-pointer ${
